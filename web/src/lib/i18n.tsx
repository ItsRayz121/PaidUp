...
const copy: Record<string, string> = {
  ...
  "settings.theme.light.desc": "Light background. Choose this if you prefer it.",
  "settings.theme.vault": "Dark",
  "settings.theme.vault.desc": "Dark background with a glowing balance. The normal look.",
