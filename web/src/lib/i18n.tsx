...
const dict: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "withdraw.aboutEquals": "= about {value}",
    "withdraw.getPaidUsdt": "Get paid in USDT",
    "withdraw.pkrRow": "Bank / JazzCash / EasyPaisa (PKR)",
  ...
  ur: {
    ...
    "withdraw.aboutEquals": "= تقریباً {value}",
    "withdraw.getPaidUsdt": "USDT میں ادائیگی لیں",
    "withdraw.pkrRow": "بینک / جاز کیش / ایزی پیسہ (PKR)",
